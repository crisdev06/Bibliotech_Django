    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_prestamo', models.CharField(choices=[('VIGENTE', 'Vigente'), ('DEVUELTO', 'Devuelto'), ('ATRASADO', 'Atrasado')], default='VIGENTE', max_length=20, verbose_name='Estado del Préstamo')),
